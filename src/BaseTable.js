...
class BaseTable extends React.PureComponent {
    ...
    getTotalRowsHeight() {
        ...
        if (estimatedRowHeight) {
            return this.table
                ? this.table.getTotalRowsHeight() || 0
                : this._getEstimatedTotalRowsHeight(this._data, estimatedRowHeight) || 0;
        }
    ...
    renderRowCell({ isScrolling, columns, column, columnIndex, rowData, rowIndex, expandIcon }) {
        ...
        const { className, dataKey, dataGetter, cellRenderer, render } = column;
    ...
    _getTableHeight() {
        ...
        // console.log('_getTableHeight', height, this.props);
        return tableHeight;
    }
